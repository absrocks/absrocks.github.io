...
<div class="row justify-content-sm-center">
    ...
    <div class="col-sm-6 mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/flex-four-5e5-SP1.5D.gif" title="four cylinders" class="img-fluid rounded z-depth-1" style="transform: scaleY(1.2); transform-origin: center;" %}
    </div>
</div>
<div class="caption">
